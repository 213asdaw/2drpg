...
igris_path = cards_src / "igris_companion.png"
igris = Image.open(igris_path).convert("RGBA") if igris_path.exists() else army
...
assignments = {
    ...
    "bodyguard.png": tint(igris, (40, 0, 90, 255), 0.12, 1.05, 0.95),
    "unleash.png": tint(strike, (90, 0, 120, 255), 0.22, 1.3, 1.05),
    "reanimate.png": tint(igris, (20, 40, 80, 255), 0.15, 1.1, 0.95),
    ...
    "legion_of_bone.png": tint(igris, (30, 30, 50, 255), 0.18, 1.0, 0.9),
    ...
    "sic_em.png": tint(igris, (100, 20, 40, 255), 0.15, 1.15, 1.0),
